...
interface IpodSvgOutlineRingBlockProps {
  ...
  className?: string;
  /** Softer, single-accent ring (gradient / desktop mesh). */
  appearance?: SvgOutlineRingAppearance;
}

export function IpodSvgOutlineRingBlock({
  displayMode,
  currentTrack,
  coverUrl,
  durationSec,
